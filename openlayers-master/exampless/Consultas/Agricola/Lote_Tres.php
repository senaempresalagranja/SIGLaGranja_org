        ...
        <?php 
            ...
            $consulta=pg_query($con,"SELECT area.arenombre,suelo.suefhumedad,suelo.sueftextura,suelo.sueqph,suelo.suefporocida,lote.lotidcodigo,lote.lotextension,lote.lotunimedlot,lote.lotlatitud,lote.lotorientlat,lote.lotlongitud,lote.lotorientlon,suelo.suefconsiste,suelo.suefcolorter,suelo.suefcondelet,suelo.sueqnitrogen,suelo.sueqfosforo,suelo.sueqpotacio,suelo.sueqelemmeno,suelo.sueqeleminte,suelo.suebmateorga,suelo.suebactimicr,suelo.suebmasmicro 
                FROM lote_cultivo
                  ...
                  inner join suelo on suelo.sueid = lote.lotsuelo WHERE lote.lotidcodigo='LOTE 3'");
        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: LOTE 3</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                   ...
                   <tr class="hola">
                        ...
                        FROM lote_cultivo
                        inner join lote on lote.lotid = lote_cultivo.lculote 
                        INNER JOIN unidad ON unidad.uniid = lote_cultivo.lcuunidad  WHERE lote.lotidcodigo='LOTE 3'" );
                        ...
                        FROM lote_cultivo
                        inner join lote on lote.lotid = lote_cultivo.lculote 
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE lote.lotidcodigo='LOTE 3'" );
                        ...
                        FROM lote_cultivo
                        inner join lote on lote.lotid = lote_cultivo.lculote                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal  WHERE lote.lotidcodigo='LOTE 3'" );
                    ...
                    <tr>
                       ...
                       <center>
                    <a href="../descarga_excel/LoteTres_exc.php" target="_blank">
