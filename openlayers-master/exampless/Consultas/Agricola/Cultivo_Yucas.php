...
include 'conexion.php';
       ...
       cultivo.culunimedsie
                  ...
                  inner join suelo on suelo.sueid = lote.lotsuelo
                   WHERE cultivo.culnomcomun='YUCA'");
        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: CULTIVO YUCA</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr class="td2">
                        ...
                        FROM lote_cultivo                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE cultivo.culnomcomun='YUCA'" );
                    ...
                    <tr class="hola">
                        <td class="celdatdazul"><b>LOTES QUE CULTIVAN YUCA:</b></td><!---HAGO DE CUENTA QUE ES EL REGISTRO 02 -->
                   
                
                        <td colspan="2" class="celdatdazul"><?php
                        include 'conexion.php';
                    ...
                    <tr>
                     <td class="celdatd" colspan="4">
                       <center>
                    <a href="../descarga_excel/CultivoYucas_exc.php" target="_blank">
