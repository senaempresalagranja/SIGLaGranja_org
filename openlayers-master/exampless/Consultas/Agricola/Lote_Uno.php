        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: LOTE 1</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                   ...
                   <tr class="hola">
                        ...
                        FROM lote_cultivo 
                        inner join lote on lote.lotid = lote_cultivo.lculote
                        INNER JOIN unidad ON unidad.uniid = lote_cultivo.lcuunidad  WHERE lote.lotidcodigo='LOTE 1'" );
                        ...
                        FROM lote_cultivo
                        inner join lote on lote.lotid = lote_cultivo.lculote 
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE lote.lotidcodigo='LOTE 1'" );
                        ...
                        FROM lote_cultivo
                        inner join lote on lote.lotid = lote_cultivo.lculote                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal  WHERE lote.lotidcodigo='LOTE 1'" );
                    ...
                    <tr>
                       ...
                       <center>
                    <a href="../descarga_excel/LoteUno_exc.php" target="_blank">
