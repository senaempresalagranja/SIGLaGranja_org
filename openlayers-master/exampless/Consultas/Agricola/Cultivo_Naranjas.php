...
<body>
    ...
    FROM lote_cultivo
                  ...
                  WHERE cultivo.culnomcomun='NARANJA'");

                  //inner join plagaenferme_cultivo on pcukidcodigo = lote_cultivo.lcuplagenfer
        ...
        <center>
            <table border='0' width="2%" style="border: solid #000;">
                <tr>
                    <td colspan="4" class="tabla0">
                       <div ><center><b>FICHA TECNICA: CULTIVO NARANJA</b></center></div><br>
                   </td>
               </tr>
               <tr>
            ...
            <tr class="td2">
                ...
                <td colspan="2"><?php
                    ...
                    $con_canales= pg_query($con, "SELECT DISTINCT canal.cannombre
                        FROM lote_cultivo                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE cultivo.culnomcomun='NARANJA'" );
                ...
                <tr class="hola">
                    <td class="celdatdazul"><b>LOTES QUE CULTIVAN NARANJA:</b></td><!---HAGO DE CUENTA QUE ES EL REGISTRO 02 -->
            ...
            <tr>
               <td class="celdatdazul" colspan="4">
                 <center>
                    <a href="../descarga_excel/CultivoNaranjas_exc.php" target="_blank">
