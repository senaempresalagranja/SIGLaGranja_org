...
<html lang="es">
    <head>
        <meta charset="utf-8"/>
        <title>CULTIVO YERBABUENA</title>
        <style type="text/css">
...
include 'conexion.php';
       ...
       cultivo.culunimedsie
                  ...
                  inner join suelo on suelo.sueid = lote.lotsuelo
                   WHERE cultivo.culnomcomun='YERBABUENA'");
        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: CULTIVO YERBABUENA</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="td2">
                        ...
                        FROM lote_cultivo                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE cultivo.culnomcomun='YERBABUENA'" );
                    ...
                    <tr class="hola">
                        <td class="celdatdazul"><b>LOTES QUE CULTIVAN YERBABUENA:</b></td><!---HAGO DE CUENTA QUE ES EL REGISTRO 02 -->
                    ...
                    <tr>
                     <td class="celdatdazul" colspan="4">
                       <center>
                    <a href="../descarga_excel/CultivoAromaticas_exc.php" target="_blank">
