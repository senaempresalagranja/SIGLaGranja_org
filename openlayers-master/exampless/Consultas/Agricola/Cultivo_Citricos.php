...
include 'conexion.php';
       ...
       cultivo.culunimedsie
                  ...
                  inner join suelo on suelo.sueid = lote.lotsuelo
                    ...
                    WHERE cultivo.culnomcomun='PIÑA'");
        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: CULTIVO PIÑA</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr class="td2">
                        ...
                        FROM lote_cultivo                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE cultivo.culnomcomun='PIÑA'" );
                    ...
                    <tr class="hola">
                        <td class="celdatdazul"><b>LOTES QUE CULTIVAN PIÑA:</b></td><!---HAGO DE CUENTA QUE ES EL REGISTRO 02 -->
                    ...
                    <tr>
                     <td class="celdatdazul" colspan="4">
                       <center>
                    <a href="../descarga_excel/CultivoCitricos_exc.php" target="_blank">
