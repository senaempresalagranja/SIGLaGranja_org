...
include 'conexion.php';
       ...
       cultivo.culunimedsie              
                  ...
                  WHERE cultivo.culnomcomun='PERA'");
        ...
        <center>
                ...
                <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: CULTIVO PERA</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <tr class="td2">
                        ...
                        FROM lote_cultivo                        
                        INNER JOIN canal ON canal.canid= lote_cultivo.lcucanal
                        INNER JOIN cultivo ON cultivo.culid = lote_cultivo.lcucultivo  WHERE cultivo.culnomcomun='PERA'" );
                    ...
                    <tr class="hola">
                        <td class="celdatdazul"><b>LOTES QUE CULTIVAN PERA:</b></td><!---HAGO DE CUENTA QUE ES EL REGISTRO 02 -->
                    ...
                    <td class="celdatd" colspan="4">
                       <center>
                    <a href="../descarga_excel/CultivoAnonaceas_exc.php" target="_blank">
