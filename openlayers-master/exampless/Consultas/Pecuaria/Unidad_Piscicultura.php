        ...
        <article>
            <center>
                <table border='0' width="25%" style="border: solid #000;">
                    <tr>
                        <td colspan="4" class="tabla0">
                             <div >
                                <center>
                                    <b>
                                        FICHA TECNICA: UNIDAD PISCICULTURA
                                    </b>
                                </center>
                            </div>
                            <br>
                    ...
                    <tr class="td2">
                        <td colspan='0' class="celdatdazul"><b>ENFERMEDADES EN LA PRODUCCION:</b></td>
                        <td colspan="2" class="celdatdazul">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr>
                    <tr class="td2">
                        <td colspan='0' class="celdatd"><b>POSTES:</b></td>
                        <td colspan="2" class="celdatd">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr class="td2">
                        <td colspan='0' class="celdatdazul"><b>REDES ELECTRICAS:</b></td>
                        <td colspan="2" class="celdatdazul">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr>
                    <tr class="td2">
                        <td colspan='0' class="celdatd"><b>REDES  GAS:</b></td>
                        <td colspan="2" class="celdatd">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr class="td2">
                        <td colspan='0' class="celdatdazul"><b>REDES LOGICAS:</b></td>
                        <td colspan="2" class="celdatdazul">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr class="td2">
                        <td colspan='0' class="celdatd"><b>REDES SANITARIAS:</b></td>
                        <td colspan="2" class="celdatd">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr class="td2">
                        <td colspan='0' class="celdatdazul"><b>RUTAS:</b></td>
                        <td colspan="2" class="celdatdazul">
                    <?php
                        include 'conexion.php';
                    ...
                    <tr>
                    <td class="celdatd" colspan="4">
                       <center>
                    <a href="../descarga_excel/Piscicultura_exc.php" target="_blank">
