...
header("Content-Disposition: attachment; filename=TABLA PORCINOS.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="7">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> TABLA UNIDAD PORCINOS </font></div></th>
    <th colspan="2">
...
<?php
    ...
    $Consulta = pg_query($con,
                                ...
                                WHERE unidad.uninombre = 'PORCINOS'");
