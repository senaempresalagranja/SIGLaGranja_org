...
header("Content-Disposition: attachment; filename=TABLA CULTVO GUAYABA.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="9">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> TABLA CULTIVO GUAYABA </font></div></th>
    <th colspan="2">
