...
header("Content-Disposition: attachment; filename=TABLA PISCICULTURA.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="7">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> TABLA UNIDAD PISCICULTURA </font></div></th>
    <th colspan="2">
...
<?php
    ...
    $Consulta = pg_query($con,
                                ...
                                WHERE unidad.uninombre = 'PISCICULTURA'");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="3">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> ESTANQUES </font></div></th>
</table>
<table width="641" border="1">
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>NOMBRE</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>TIPO</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>PROFUNDIDAD</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>U/M<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>ESPEJO DE AGUA</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>U/M</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>VOLUMEN</strong></th>
<th width="50%" style="background-color:#0000ff; text-align:center; color:#FFF"><strong>U/M</strong></th>
<?php
$Consulta_Especie = pg_query($con,
                                "SELECT
                                ...
                                while ($Reg_Raza= pg_fetch_array($Consulta_Especie)) 
                                    {
                                        ...
                                        $reg00006=utf8_decode($Reg_Raza[5]);
                                        $reg00007=utf8_decode($Reg_Raza[5]);
                                        $res1=pg_query($con, "SELECT * FROM unidad_medida WHERE umeid=$reg00003");
                                        while($reg_estanquea=pg_fetch_array($res1))
                                            {
                                                $nombre1=($reg_estanquea[1]);
                                            }
                                        $res5=pg_query($con, "SELECT * FROM unidad_medida WHERE umeid=$reg00005");
                                        while($reg_estanqueb=pg_fetch_array($res5))
                                            {
                                                $nombre2=($reg_estanqueb[1]);
                                            }
                                            $res7=pg_query($con, "SELECT * FROM unidad_medida WHERE umeid=$reg00007");
                                        while($reg_estanquec=pg_fetch_array($res7))
                                            {
                                                $nombre3=($reg_estanquec[1]);
                                            }
               ...
               <td bgcolor=\"#fff\" align=\"center\">$reg00000</td>
                ...
                <td bgcolor=\"#fff\" align=\"center\">$nombre2</td>
                <td bgcolor=\"#fff\" align=\"right\">$reg00006</td>
                <td bgcolor=\"#fff\" align=\"center\">$nombre3</td>
