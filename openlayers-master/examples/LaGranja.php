...
<script>
    ...
    function load() {
        ...
        var PolAdmin = new OpenLayers.Layer.Vector("Mapa Administrativo", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/AgricolaP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
        ...
        var PolAdminAg = new OpenLayers.Layer.Vector("Mapa Administrativo", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/AgroindustriaP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
                    maxDepth: 2
        ...
        var PolAdminMe = new OpenLayers.Layer.Vector("Mapa Administrativo", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/MecanizacionP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
                    maxDepth: 2
        ...
        var PolAdminPe = new OpenLayers.Layer.Vector("Mapa Administrativo", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/PecuariaP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
                    maxDepth: 2
          ...
          var PolAdminAM = new OpenLayers.Layer.Vector("Mapa Administrativo", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/AmbientalP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
                    maxDepth: 2
         ...
         var Poligono= new OpenLayers.Layer.Vector("Area Total", {
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "kml/KmlPolitico/GestiondeCentroP.kml",
                format: new OpenLayers.Format.KML({
                    extractStyles: true, 
                    extractAttributes: true,
                    maxDepth: 2
        ...
        var group = [Poligono];  
        for (var i=0; i < group.length; i++) { group[i].group = 'Gestion/Gestion de Centro'; }
        ...
        PoligonoPo.setVisibility(false);
        ...
        var fpControl = new OpenLayers.Control.FeaturePopups({
                ...
                [
                    PolAdmin , {templates: {
                      single: '<table border="0"><tr><td width="200px"><center><h1>Agricola</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                       

                    }}
                ],
                [
                  PolAdminAg , {templates: {
                    single: '<table border="0"><tr><td width="200px"><center><h1>Agroindustria</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                       

                    }}
                ],
                [
                  PolAdminMe , {templates: {
                    single: '<table border="0"><tr><td width="200px"><center><h1>Mecanizacion</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                       

                    }}
                ],
                [
                  PolAdminPe , {templates: {
                    single: '<table border="0"><tr><td width="200px"><center><h1>Pecuaria</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                    }}
                ],
                [
                  PolAdminAM , {templates: {
                    single: '<table border="0"><tr><td width="200px"><center><h1>Gestion Ambiental</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                    }}
                ],
                [
                  Poligono , {templates: {
                        single: '<table border="0"><tr><td width="200px"><center><h1>Gestion/Gestion de Centro</h1></td></tr><tr><td width="200px"><img src="img/logo.ico" class="LotesCultivos"></td></tr></table>',
                    }}
                ],      
