...
<?php
    ...
    [   
        ...
        <?php echo str_replace(array('-' , ' ' ), '', $reg[1]);?> , {templates: {
          single: "<table border='0'><tr><td width='200px'><center><h5><?php echo $reg[1] ;?></h5></td></tr><tr><td width='200px'><img src='img/logo.ico' class='LotesCultivos'></td></tr><tr><td><center><input type='submit' value='Ver m&aacute;s informaci&oacute;n' onclick='Unidad(`<?php echo $reg[1];?>`)'></center></td></tr></table>",
...
<ul>
    <button class="GESTION">
      <li> <a href="Zonas_Comunes3.php" class="menu" ><font color="black">Gestion/Gestion de Centro</a></li> 
  </button>
</ul>
<ul>
