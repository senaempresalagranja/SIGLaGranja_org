                ...
                <table border='0' width="2%" style="border: solid #000;">
                    <tr>
                        <td colspan="4" class="tabla0">
                             <div ><center><b>FICHA TECNICA: TRANSPORTE Y MANTENIMIENTO</b></center></div><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <td class="celdatdazul" colspan="4">
                       <center>
                    <a href="../descarga_excel/MantTransporte_exc.php" target="_blank">
