...
header("Content-Disposition: attachment; filename=TABLA APICULTURA.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="7">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> TABLA UNIDAD APICULTURA </font></div></th>
    <th colspan="2">
...
$Consulta_Construccion = pg_query($con,
               ...
               <tr>
                ...
                <td bgcolor=\"#fff\" align=\"center\">$reg02</td>
