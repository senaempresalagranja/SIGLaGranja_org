...
header("Content-Disposition: attachment; filename=TABLA CONCENTRADOS.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="9">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">CONCENTRADOS </font></div></th>
    <th colspan="1">
    ...
    include 'conexion.php';
       ...
       FROM construccion
                  ...
                  inner join area on area.areid = unidad.uniarea
                   WHERE construccion.connombre='CONCENTRADOS'");
