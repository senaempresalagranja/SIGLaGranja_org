...
header("Content-Disposition: attachment; filename=TABLA GANADERIA.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="7">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2"> TABLA UNIDAD GANADERIA </font></div></th>
    <th colspan="2">
