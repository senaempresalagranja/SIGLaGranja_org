...
<th width="50%" style="background-color:#0000FF; text-align:center; color:#FFF">TOMA REGULAR</th>
<th width="50%" style="background-color:#0000FF; text-align:center; color:#FFF">TOMA NO REGULAR</th>
<th width="50%" style="background-color:#0000FF; text-align:center; color:#FFF">TOMA TRIFASICO</th>
...
while($reg=pg_fetch_array($res))
{
	...
	echo "	<tr>
					...
					<td bgcolor=\"#fff\" align=\"right\">$tomar</td>
					<td bgcolor=\"#fff\" align=\"right\">$tomanr</td>
