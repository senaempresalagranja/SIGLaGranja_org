...
header("Content-Disposition: attachment; filename=Excel_UnidadesPlaga.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="6">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: UNIDADES CON PLAGAS</font></div></th>
    <th colspan="5">
