...
header("Content-Disposition: attachment; filename=Excel_UnidadesPostes.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="8">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: UNIDADES CON POSTES</font></div></th>
    <th colspan="9">
...
$CodArea=$_SESSION['CodArea'];
 ...
 $consulta= pg_query($con,"SELECT
            ...
            INNER JOIN area ON area.areid = unidad.uniarea where uniarea = '$CodArea' ORDER BY uninombre ASC");
