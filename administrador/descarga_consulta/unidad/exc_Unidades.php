...
header("Content-Disposition: attachment; filename=Excel_Unidades.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="9">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: TODAS UNIDADES</font></div></th>
    <th colspan="8">
...
$uniarea=$_SESSION['uniarea'];
 ...
 $consulta= pg_query($con,"SELECT 
            ...
            unidad.uniorientlon
            FROM unidad
            INNER JOIN area ON area.areid = unidad.uniarea WHERE uniarea = '$uniarea' order by uninombre asc");
