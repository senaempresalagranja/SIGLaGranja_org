...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="10">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: ESTANQUE</font></div></th>
    <th colspan="3">
...
$Estanque=$_SESSION['EstanqueExcel'];
// Un proceso repetitivo para imprimir cada uno de los registros.
 $consulta= pg_query($con,"SELECT 
                      ...
                      INNER JOIN area ON area.areid = unidad.uniarea WHERE estid = '$Estanque' order by estnombre asc");
