...
header("Content-Disposition: attachment; filename=Excel_UnidadEnfermedad.xls");
...
$sessionUnidad=$_SESSION['CodUnidad'];
 ...
 $Consultar= pg_query("SELECT 
                  ...
                  INNER JOIN area ON area.areid = unidad.uniarea  WHERE uniid='$sessionUnidad' order by uninombre asc");
