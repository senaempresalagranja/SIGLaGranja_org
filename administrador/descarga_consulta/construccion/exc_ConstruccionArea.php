...
header("Content-Disposition: attachment; filename=Excel_AreasConstruccion.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="8">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: AREAS CON COSTRUCCIONES</font></div></th>
    <th colspan="8">
