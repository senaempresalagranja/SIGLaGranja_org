...
header("Content-Disposition: attachment; filename=Excel_AreasRuta.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="6">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: AREAS CON RUTAS</font></div></th>
    <th colspan="12">
...
include ('conexion.php');
 ...
 $consulta= pg_query($con,"SELECT        
            ...
            INNER JOIN ruta ON ruta.rutid = ruta_unidad.runruta order by uninombre asc");
            ...
            while ($reg= pg_fetch_array($consulta)) 
                      ...
                      <tr>
                        ...
                        <td align=\"right\">$reg[10]</td>
                        <td align=\"left\">$reg[11]</td>
                        <td align=\"right\">$reg[12]</td>
                        <td align=\"left\">$reg[13]</td>
                        <td align=\"right\">$reg[14]</td>
                        <td align=\"left\">$reg[15]</td>
                        <td align=\"right\">$reg[16]</td>
                        <td align=\"left\">$reg[17]</td>
                    </tr>";                   
                      }
?>
</table></center>
