...
for ($i = 0; $i < count( $unidad ) ; $i++)
{
	...
	$mipdf -> SetTextColor( 255, 255 ,255);
	$mipdf -> SetFillColor(  0 , 0 ,255);
	$mipdf -> Cell ( 20, 10 , $unidad[ $i ] , 1 , 0 , 'C' , true );	
}
for ($i = 0; $i < count( $canal ) ; $i++)
{
	...
	$mipdf -> SetTextColor( 255, 255 ,255);
	$mipdf -> SetFillColor(  0 , 0 ,255);
	$mipdf -> Cell ( 45, 10 , $canal[ $i ] , 1 , 0 , 'C' , true );	
}
for ($i = 0; $i < count( $plagaenfermedad ) ; $i++)
{
	...
	$mipdf -> SetTextColor( 255, 255 ,255);
	$mipdf -> SetFillColor(  0 , 0 ,255);
	$mipdf -> Cell ( 37, 10 , $plagaenfermedad[ $i ] , 1 , 0 , 'C' , true );	
}
...
for ($i = 0; $i < count( $responsable ) ; $i++)
{
	...
	$mipdf -> SetTextColor( 255, 255 ,255);
	$mipdf -> SetFillColor(  0 , 0 ,255);
	$mipdf -> Cell ( 32, 10 , $responsable[ $i ] , 1 , 0 , 'C' , true );	
}
$mipdf -> Ln( 10);
...
$res=pg_query($con, "SELECT * FROM unidad_cultivo ORDER BY lcuid ASC");
	...
	$mipdf -> Cell( 20, 10 , $NomUnidad, 1, 0, 'L' , true );
	$mipdf -> Cell( 45, 10 , $NomCanal, 1, 0, 'L' , true );
	$mipdf -> CellFitSpace( 37, 10 , $NomComunPlaEnf, 1, 0, 'L' , true );
	...
	$mipdf -> Cell( 32, 10 , $responsable, 1, 0, 'L' , true );
	$mipdf -> Ln( 10);	
}   
