        ...
        <table whidt="100%" class="table">
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" name="orilatitud" id= "orilatitud" class="inp-ent" value="<?php if (isset($pesorientlat)) {echo "$pesorientlat";} ?>" placeholder=" N / S" onblur="revisarn(this)"  readonly="readonly"></td>
          </tr>
          <tr>
            <td colspan="3"></td>
            <td>LONGITUD:</td>
            <td>
              ...
              <input type="text" name="orilongitud" id="orilongitud" class="inp-ent" value="<?php if (isset($pesorientlog)) {echo "$pesorientlog";} ?>" placeholder=" E / O" Onblur="revisarn(this)" readonly="readonly"></td> 
          </tr>      
          <tr>
