...
header("Content-Disposition: attachment; filename=Excel_UnidadesEnfermedad.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="6">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: UNIDAD CON ENFERMEDADES</font></div></th>
    <th colspan="5">
...
include ('conexion.php');
$sessionUnidades=$_SESSION['uniarea'];
 ...
 $Consultar= pg_query("SELECT 
                  ...
                  INNER JOIN area ON area.areid = unidad.uniarea  WHERE uniarea='$sessionUnidades' order by uninombre asc");
