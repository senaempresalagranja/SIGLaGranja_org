...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="7">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: UNIDAD CON CANALES</font></div></th>
    <th colspan="16">
...
$sessionUnidad=$_SESSION['CodUnidad'];
 ...
 $consulta= pg_query($con,"SELECT
            ...
            INNER JOIN canal ON canal.canid = unidad_canal.cuncanal where uniid = '$sessionUnidad' order by uninombre ASC");
