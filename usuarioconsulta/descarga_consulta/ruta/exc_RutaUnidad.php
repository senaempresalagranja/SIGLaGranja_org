...
header("Content-Disposition: attachment; filename=Excel_UnidadRuta.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="6">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: UNIDAD CON RUTAS</font></div></th>
    <th colspan="12">
...
$sessionUnidad=$_SESSION['CodUnidad'];
 ...
 $consulta= pg_query($con,"SELECT        
            ...
            INNER JOIN ruta ON ruta.rutid = ruta_unidad.runruta where rununidad = '$sessionUnidad' order by uninombre asc");
