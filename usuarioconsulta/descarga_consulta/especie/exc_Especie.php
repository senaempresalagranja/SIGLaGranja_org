...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="3">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: ESPECIE</font></div></th>
    <th colspan="8">
...
// Un proceso repetitivo para imprimir cada uno de los registros.
 ...
 $consulta= pg_query($con,"SELECT 
                      ...
                      INNER JOIN area ON area.areid = unidad.uniarea WHERE espid = '$Especie' order by espnomcomun asc");
