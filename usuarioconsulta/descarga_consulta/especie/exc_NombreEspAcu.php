...
header("Content-Disposition: attachment; filename=Excel_NombreEspAcu.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="5">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: NOMBRES ESPECIES (ACUATICAS)</font></div></th>
    <th colspan="8">
...
// Un proceso repetitivo para imprimir cada uno de los registros.
  ...
  $NombreEspAcu=$_SESSION['NombreEspAcu'];
 $consulta= pg_query($con,"SELECT 
                      ...
                      INNER JOIN area ON area.areid = unidad.uniarea where eacnomcomun LIKE '%$NombreEspAcu%' order by eacnomcomun asc");
