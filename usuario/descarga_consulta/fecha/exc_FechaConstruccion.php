...
header("Content-Disposition: attachment; filename=Excel_ConstruccionesFecha.xls");
...
<table width="1000" border="0">
  <tr>
    <th width="1000" colspan="9">
      <div style="color:#0000ff; text-shadow:#666;"><font size="+2">REPORTE: FECHAS DE LAS CONSTRUCCIONES</font></div></th>
    <th colspan="9">
...
// Un proceso repetitivo para imprimir cada uno de los registros.
  $Construccion=$_SESSION['ExcelConstruccion'];
  $Remodelacion=$_SESSION['ExcelRemodelacion'];
