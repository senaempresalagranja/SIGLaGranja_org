...
{  font: normal 12px/150% Arial, Helvetica, sans-serif; 
  ...
  padding: 4px 7px;}.GrillaConsulta table thead th 
...
.GrillaConsulta table tbody td:first-child { 
  border-left: groove;}.GrillaConsulta table tbody tr:last-child td {   border-bottom: groove;}
</style>
